    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            */
            ...
            // ****** Unecessary for default install ********
        ...
        private void chechVBS2AppVersion()
        {
            ...
            //This will check for exitance of default location and enable button
            if (System.IO.File.Exists(defaultVBS2path + vbs2executable))
            {
        ...
        private void button_launchvbs2_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox_mod.Checked == true && textBoxModSwitches.Text == "")
        ...
        private void radioCheckButtons()
        {
            ...
            if (radioButton_v150.Checked)
            {
                vbs2launchpath = defaultVBS2path + vbs2executable;
            }
